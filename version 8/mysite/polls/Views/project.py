    ...
    with mp_hand.Hands(min_detection_confidence=0.5,
        ...
        while True:
            ...
            if not keyPressed and len(current_key_pressed) != 0:
                ...
                # guster recognation and data insertion
                if res == [1, 1] and sec == [0, 0, 0]:
                    name = My_car.objects.all()
                    q = My_car(Number_of_brakes=my_break, player_name='Muhammad ijaz',
                               player_ID='18jzbcs0068', RANK='SILVER')
                    q.save()
                    print('Data Sent...')
                    my_break = 0
